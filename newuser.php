 ...
 <a class="navbar-brand" href="#page-top">Brand image</a>
	...
	<div id="page-content-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
			<form id="registerbox" method="post" action="php/registerin.php" >
			<span id="fn"></span>
			...
			<input type="submit" value="Register me!" class="go" id="go" name="submit"<?php if (isset($_SESSION['email'])){echo "disabled=true";} ?> />
